...
public class ColorChooser extends javax.swing.JFrame {
     ...
     */
    public ColorChooser(ClockPanel p) {
        initComponents();
        this.p = p;
        ...
        model.addChangeListener(new javax.swing.event.ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ColorChooser.this.p.setMainColor(jColorChooser1.getColor());
            }
        });
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        p.setMainColor(jColorChooser1.getColor());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ColorChooser(null).setVisible(true);
            }
        });
    }
